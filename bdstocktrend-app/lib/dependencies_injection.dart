...
void _useCase() {
  ...
  sl.registerLazySingleton(() => GetCompanyDetails(sl()));
...
void _cubit() {
  ...
  /// Companies
  sl.registerFactory(() => CompanyListCubit(sl()));
  sl.registerFactory(() => CompanyDetailsCubit(sl()));
