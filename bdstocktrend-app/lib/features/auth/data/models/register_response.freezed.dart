...
abstract class $RegisterResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String? token, String? error, String? message});
}
...
class _$RegisterResponseImpl extends _RegisterResponse {
  const _$RegisterResponseImpl({this.id, this.token, this.error, this.message})
      : super._();
  ...
  @override
  String toString() {
    return 'RegisterResponse(id: $id, token: $token, error: $error, message: $message)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, token, error, message);
...
abstract class _RegisterResponse extends RegisterResponse {
  const factory _RegisterResponse(
      ...
      final String? token,
      final String? error,
      final String? message}) = _$RegisterResponseImpl;
