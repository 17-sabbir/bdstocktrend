...
class _$RegisterImpl implements _Register {
  const _$RegisterImpl({this.token, this.message});
  ...
  @override
  String toString() {
    return 'Register(token: $token, message: $message)';
  }
...
abstract class _Register implements Register {
  const factory _Register({final String? token, final String? message}) =
      _$RegisterImpl;
