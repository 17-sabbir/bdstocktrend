...
public class SDKDataModel {
        ...
        @Expose
        private CustomerInfoInitializer customerInfoInitializer = new CustomerInfoInitializer();
        ...
        @Expose
        private SslcProductInitializer sslcProductInitializer = new SslcProductInitializer();
