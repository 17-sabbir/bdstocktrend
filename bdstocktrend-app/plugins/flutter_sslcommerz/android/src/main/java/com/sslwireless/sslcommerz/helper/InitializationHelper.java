...
public class InitializationHelper {
    public static SSLCProductInitializer initiateProductInitializer(SDKDataModel sdkDataModel) {
        if (sdkDataModel.getSslcProductInitializer().getAirlinesTicket() != null) {
            return new SSLCProductInitializer(sdkDataModel.getSslcProductInitializer().getProductName(),
    ...
    public static SSLCShipmentInfoInitializer initiateShipmentInfo(SDKDataModel sdkDataModel) {
        return new SSLCShipmentInfoInitializer(sdkDataModel.getSslcShipmentInfoInitializer().getShipmentMethod(),
    ...
    public static SSLCCustomerInfoInitializer initiateCustomerInfo(SDKDataModel sdkDataModel) {
        return new SSLCCustomerInfoInitializer(sdkDataModel.getCustomerInfoInitializer().getCustomerName(),
    ...
    public static SSLCommerzInitialization sslCommerzInitialization(SDKDataModel sdkDataModel) {
        ...
        if (sdkDataModel.getInitializer().getLanguage() != null)
            sslCommerzInitialization.setLanguage(sdkDataModel.getInitializer().getLanguage());
    ...
    public static SSLCAdditionalInitializer getAdditionalInitializer(SDKDataModel sdkDataModel) {
        Log.e("TEST2",
                "sdkDataModel getAdditionalInitializer " + sdkDataModel.getSslcAdditionalInitializer().getExtra());
        ...
        if (sdkDataModel.getSslcAdditionalInitializer().getExtra() != null)
            sslcAdditionalInitializer.setExtra(sdkDataModel.getSslcAdditionalInitializer().getExtra());
    ...
    public static SSLCEMITransactionInitializer initiateEmiTransaction(SDKDataModel sdkDataModel) {
        ...
        SSLCEMITransactionInitializer emitrans = new SSLCEMITransactionInitializer(
                sdkDataModel.getSslcemiTransactionInitializer().getEmiOptions());
        if (sdkDataModel.getSslcemiTransactionInitializer().getEmiMaxListOptions() != null)
            emitrans.emi_max_list_options = sdkDataModel.getSslcemiTransactionInitializer().getEmiMaxListOptions();
        if (sdkDataModel.getSslcemiTransactionInitializer().getEmiSelectedInst() != null)
            emitrans.emi_selected_inst = sdkDataModel.getSslcemiTransactionInitializer().getEmiSelectedInst();
        return emitrans;
    }
