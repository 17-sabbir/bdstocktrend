...
class SSLCEMITransactionInitializer {
  ...
  SSLCEMITransactionInitializer(
      {required this.emi_options,
      this.emi_max_list_options,
      this.emi_selected_inst});

  Map<String, dynamic> toJson() => _$SSLCEMITransactionInitializerToJson(this);
  factory SSLCEMITransactionInitializer.fromJson(Map<String, dynamic> json) =>
      _$SSLCEMITransactionInitializerFromJson(json);
